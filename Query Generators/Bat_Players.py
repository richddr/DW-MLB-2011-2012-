...
file = open("../CSV/batting2011.txt")
output = open("../Queries/Batting_Queries2011.txt", 'w')
i = 841
year = "2011"
...
while 1:
    ...
    if not line:
        ...
        insert_l= "insert into BATEO_JUGADOR_EQUIPO values( "+ str(i) +", "+ team_rep +", " + year
